...
export default function OrderContents({order, decrementItem ,removeItem} : OrderContentsProps) {
  return (
    <div>
          ...
          {order.map(item => (
                <div key={item.id} className="flex justify-between items-center border-t border-gray-200 py-5 last-of-type:border-b">
                  ...
                  <div className="flex space-x-2">
                    <button
                      className="bg-yellow-500 h-8 w-8 rounded-full text-white font-black"
